...
Analog Clock</option><option value="2" id="cma">Matrix Clock</option><option 
...
name="O2" type="number" min="0" max="255" required><br>12h LED: <input 
